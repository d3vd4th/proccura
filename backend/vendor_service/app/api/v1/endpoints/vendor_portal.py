...
from app.schemas.vendor_questionnaire import VendorQuestionnaireAssignmentOut, VendorQuestionnaireSubmit
...
def get_vendor_assigned_questionnaires(
    ...
    """
    registration = get_vendor_registration_for_user(db, user)
